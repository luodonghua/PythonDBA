...
with open('IOTDataDemo.csv', 'w') as csvfile:
    ...
    while (counter <= 864000*4) : # 24*60*60 = 86400, toal 40 days, 176MB
        ...
        start_time += datetime.timedelta(seconds=1) # changed from milliseconds=1 to seconds
        counter += 1
